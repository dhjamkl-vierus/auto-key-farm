import { Palette, Keyboard, Webhook, Eye, Bug } from "lucide-react";
...
export function SettingsPage({ cfg, set }: Props) {
  return (
    <div className="grid gap-4">
      <Card title="Appearance" icon={<Palette className="w-3.5 h-3.5" />}>
        <div className="text-xs mb-3" style={{ color: "var(--text-dim)" }}>
          Choose a color theme for the menu. Your choice persists across sessions.
        </div>
        ...
        <div className="grid gap-2">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              onClick={async () => {
                try {
                  await sendDiscord(cfg.webhookUrl, "Test message", "Sailor Piece electron webhook works.");
